                     ...
                     <div id="banner-text" class="col-md-7 text-c text-left ">
					   <br>
                        <h5 class="wow fadeInUp main-h font_30" data-wow-delay="0.2s" >WELCOME TO All City Office
                           <br><br><span class="about_text "> ABOUT US?</span>  
                        </h5>
            ...
            <div class="row text-left  ">
               <div class="col-md-7">
                  <div class="about_left_text_top wow fadeInUp">
                     <h1>WE CREATE REAL AMERICAN MADE PRODUCTS AT THE BEST QUALITY</h1>
                     <p>Starting up as a <b>woman owned business</b> focused on selling office supplies for all entities, from <b>business to government</b>, we provide quality that is known to be <b>American</b>. We keep our business <b>100% green</b>, focusing on <b>recycling product</b> such as toner to save the enviornment one step at a time.</p>
                  </div>
               </div>
               <div class="col-md-5">
<!--                   <img src="assets/images/about_images.png" class="img_radius"> -->
               </div>
            </div>
         </div>
      </div>
